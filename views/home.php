    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <a class="nav-link text-white" href="#">Workflow</a>
                </li>
                <li class="nav-item">
...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="../assets/img/Second_slider2.jpg" class="d-block w-100 img-fluid" alt="...">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img src="../assets/img/Third_Slider2.jpeg" class="d-block w-100 img-fluid" alt="...">
      <div class="carousel-caption d-none d-md-block">
...
<h3 class="text-center space_section"><strong>About</strong></h3>
...
<h3 class="text-center space_section "><strong>Our Services</strong></h3>
<div class="About py-5 text-center">
  <div class="container">
    <div class="row align-items-center">
       <!-- Left Section -->
...
<h3 class="text-center space_section"><strong>Work Flow</strong></h3>
    ...
    <div class="row align-items-center">
      ...
      <div class="card text-center">
            ...
            <div class="card-body text-center">
                <h5 class="card-title">The user will Register for his account</h5>
...
<h3 class="text-center space_section"><strong>Contact Us</strong></h3>
    ...
    <div class="col-md-4">
      <form class="needs-validation" novalidate>
        <div class="mb-3">
          ...
          <input type="text" class="form-control form-control-sm" id="validationCustom01" value="Mark" required>
