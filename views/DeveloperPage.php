    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-center">
                <li class="nav-item">
                <a class="nav-link my_nav" aria-current="page" href="catalog.php">Catalog</a>
                </li>
                <li class="nav-item">
                <a class="nav-link my_nav" href="#">Chatting</a>
                </li>
                <li class="nav-item">
                <a class="nav-link my_nav" href="developerPage.php">Developement Area</a>
                </li>
            </ul>
    ...
    <div class="chatbot">
        ...
        <ul class="chatbox">
            ...
            <!-- <li class="chat outgoing">
                <p>Ahmad Sabbagh ipsum dolor sit amet consectetur.</p>
            </li> -->
        </ul>
